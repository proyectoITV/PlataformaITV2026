if ("undefined" != typeof responsiveVoice) console.log("Sintetizador de voz cargado"), console.log(responsiveVoice);
else var ResponsiveVoice = function() {
        var a = this;
        a.version = "1.5.7";
        console.log("Voice" + a.version);
        a.responsivevoices = [{
        ...
        a.init = function() {
            ...
            a.is_opera || "undefined" === typeof speechSynthesis ? (console.log("Voice synthesis not supported"), a.enableFallbackMode()) : setTimeout(function() {
                var b = setInterval(function() {
                    ...
                    0 != c.length || null != a.systemvoices && 0 != a.systemvoices.length ? (console.log("Voice support ready"), a.systemVoicesReady(c), clearInterval(b)) : (console.log("Voice support NOT ready"),
        ...
        a.checkSpeechAllowed = function() {// modificar para permisos            
            ...
            //     b.innerHTML = '.rvNotification{position:fixed;background-color:#fff;text-align:center;font-family:-apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;font-weight:400;line-height:1;box-shadow:0 4px 8px 0 rgba(0,0,0,.2),0 6px 20px 0 rgba(0,0,0,.19);z-index:10000; opacity:0.9; width:100%; text-align:center; top:0;left:0;font-size:1rem;padding-bottom:.5em;padding-right:.5em}.rvButtonRow{padding-right:2em;padding-bottom:1em;text-align:center;font-size:medium}.rvButton{cursor:pointer;display:inline-block;margin-left:1em;padding:.8em 2em;border-radius:3px;font-size:small}.rvButtonAllow{border:none;background-color:#2b8cff;color:#fff}.rvButtonDeny{border:1px solid #2b8cff;color:#2b8cff;background-color:#fff}.rvTextRow{padding-top:1em;padding-bottom:2em}@media (min-width:576px){.rvNotification{width:60vw;left:20vw}}@media (min-width:768px){.rvNotification{width:50vw;left:25vw}}@media (min-width:992px){.rvNotification{width:40vw;left:30vw}}@media (min-width:1200px){.rvNotification{width:30vw;left:35vw}}';
            //     document.body.appendChild(b);
            //     a.allowSpeechDiv = document.createElement("div");
            //     a.allowSpeechDiv.classList.add("rvNotification");
            //     //a.allowSpeechDiv.innerHTML = '<div id="cpaudio" onclick="responsiveVoice.allowSpeechClicked(true);" class="rvButton rvButtonAllow">Aceptar Audio</div>';

            //     a.allowSpeechDiv.innerHTML = '<div id="superior2" style="position:absoule; top:0;" class="rvTextRow"><strong><img src="icon/voz.png" style="width:40px; height:40px;"><label>¿Reproducir Audio?</label></strong></div><div class="rvButtonRow"><div onclick="responsiveVoice.allowSpeechClicked(false);" class="rvButton rvButtonDeny">NO</div><div id="cpaudio" onclick="responsiveVoice.allowSpeechClicked(true);" class="rvButton rvButtonAllow">SI</div></div></script>';
            //     //a.allowSpeechDiv.innerHTML = '<div class="rvTextRow"><strong>' + window.location.hostname + '</strong> wants to use speech</div><div class="rvButtonRow"><div onclick="responsiveVoice.allowSpeechClicked(false);" class="rvButton rvButtonDeny">DENY</div><div id="cpaudio" onclick="responsiveVoice.allowSpeechClicked(true);" class="rvButton rvButtonAllow">ALLOW</div></div></script>';
            //     // var obj=document.getElementbyID('cpaudio');
            //     // obj.click();
