...
";
    ...
    padding-right: 5px;
    ".$sombra."
    '><img src='icons/atencion.png' style='width:17px;' class='pc'><span class='pc'> ".$nitavuName."</span> </td>";
   ...
   //  '><a href='nip.php'><img src='icons/candado.png' style='width:17px;'></a> </td>";
    ...
    <a href='logout.php'  title='Cerrar Sessión de ".$nitavuName."' style=''>    
    ...
    <a href='../index.php'  title='Cerrar Sessión de ".$nitavuName."' style=''>    
