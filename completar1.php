...
echo '<div id='AppDetalle'>El Dpto. de recursos humanos requiere los siguientes datos con <b>fecha limite '.fecha_larga($completar1_fecha).'</b> </div>';
...
<div>
<input value="Guardar y Continuar" type="submit" class="Mbtn btn-default">
</div>
