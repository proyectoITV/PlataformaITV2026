 ...
 if ( isset($_GET['IdDelegacion']) and isset($_GET['IdPrograma']) and isset($_GET['Saldo']) and isset($_GET['Moratorios'])  and isset($_GET['Fora']) and isset($_GET['Hasta']) and isset($_GET['Desde']) ){
    ...
    if ($Saldo == 0 and $IdDelegacion <> "" and $IdPrograma <> "" ) { // Mostrar sin Saldo de la Delegacion y Programa
        if (isset($_GET['Col']) ){
            ...
            $tb = "<h3 style='color:#484848;'>Contratos sin Saldo del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)."</b> de la Delegacion ".DelegacionNombre($IdDelegacion)." de la Colonia ".$_GET['Col']."</h3>";
            $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion,busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE saldo<=0 AND IdPrograma=".$IdPrograma." AND IdDelegacion=".$IdDelegacion."  ) a WHERE  Colonia='".$_GET['Col']."'	Order by row";
        } else {
            $tb = "<h3 style='color:#484848;'>Contratos sin Saldo del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)."</b> de la Delegacion ".DelegacionNombre($IdDelegacion)."</h3>";
            $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion, busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE saldo<=0 AND IdPrograma=".$IdPrograma." AND IdDelegacion=".$IdDelegacion." ) a WHERE row > ".$Desde." and row <= ".$Hasta." 	Order by row";
    ...
    if ($Saldo == 1 and $IdDelegacion <> "" and $IdPrograma <> "" ) { // Mostrar con Saldo de la Delegacion y Programa
        if (isset($_GET['Col']) ){
            ...
            $tb = "<h3 style='color:#484848;'>Contratos con Saldo del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)." </b>de la Delegacion ".DelegacionNombre($IdDelegacion)." de la Colonia ".$_GET['Col']."</h3>";
            $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion, busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE saldo>0 AND IdPrograma=".$IdPrograma." AND IdDelegacion=".$IdDelegacion." ) a WHERE  Colonia='".$_GET['Col']."'	Order by row";
        }
        else {
            ...
            $tb = "<h3 style='color:#484848;'>Contratos con Saldo del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)." </b>de la Delegacion ".DelegacionNombre($IdDelegacion)."</h3>";
            $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion, busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE saldo>0 AND IdPrograma=".$IdPrograma." AND IdDelegacion=".$IdDelegacion." ) a WHERE row > ".$Desde." and row <= ".$Hasta." 	Order by row";
        }
    }
    ...
    if ($Moratorios == 1 and $IdDelegacion <> ""  ) { // Mostrar solos los que tienen moratorios de la Delegacion y Programa
        if (isset($_GET['Col']) ){
            if ($IdPrograma == '0.0'){//viene de la principal | Mostrar todos los moratorios de la colonia
                $tb = "<h3 style='color:#484848;'>Contratos con Moratorio de la Colonia ".$_GET['Col']." de ".DelegacionNombre($IdDelegacion)."</h3>";
                ...
                $tb = "<h3 style='color:#484848;'>Contratos con Moratorio del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)."</b> de la Delegacion ".DelegacionNombre($IdDelegacion)." de la Colonia ".$_GET['Col']."</h3>";
        ...
        $tb = "<h3 style='color:#484848;'>Contratos con Moratorio del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)."</b> de la Delegacion ".DelegacionNombre($IdDelegacion)."</h3>";
    ...
    if ($Foraneos == 1 and $IdDelegacion <> "" and $IdPrograma <> "" ) { // Mostrar contratos que no son de la delegacion de la Delegacion y Programa        
        ...
        $tb = "<h3 style='color:#484848;'>Contratos que no son de esta Delegación del Programa <b style='color:#B5D130;'>".ProgramaNombre($IdPrograma)."</b> de la Delegacion ".DelegacionNombre($IdDelegacion)."</h3>";
        $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion, busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE IdPrograma=".$IdPrograma." AND IdDelegacion<>".$IdDelegacion.") a WHERE row > ".$Desde." and row <= ".$Hasta." 	Order by row ";
    }
    ...
    if ($IdPrograma == '0.0') {
        if (isset($_GET['Col']) ){
            if ($Moratorios ==1){
                ...
                if ($Saldo==1){
                    $tb = "<h3 style='color:#484848;'>Contratos con Saldo de la Colonia ".$_GET['Col']." de ".DelegacionNombre($IdDelegacion)."</h3>";
                    $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion, busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE Saldo > 0 AND IdDelegacion=".$IdDelegacion."  ) a WHERE  Colonia='".$_GET['Col']."' 	Order by row";
                }  else {
                    $tb = "<h3 style='color:#484848;'>Contratos sin Saldo de la Colonia ".$_GET['Col']." de ".DelegacionNombre($IdDelegacion)."</h3>";
                    $MSSQL = "SELECT * FROM ( SELECT (select Delegacion from delegaciones WHERE delegaciones.IdDelegacion = busqueda_vivienda_informacionfinanciera.IdDelegacion) as Delegacion, busqueda_vivienda_informacionfinanciera.*,(SELECT NombreCompleto FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NombreCompleto,(SELECT EstadoCivil FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS EstadoCivil,(SELECT NCElector FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS NElector,(SELECT Colonia FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Colonia,(SELECT Telefono FROM busqueda_vivienda_informacioncontratos WHERE NumContrato=busqueda_vivienda_informacionfinanciera.NumContrato) AS Telefono,(SELECT Curp FROM vivienda_datosgenerales WHERE Folio=busqueda_vivienda_informacionfinanciera.Folio AND IdDelegacion=busqueda_vivienda_informacionfinanciera.IdDelegacion AND IdPrograma=busqueda_vivienda_informacionfinanciera.IdPrograma) AS CURP, ROW_NUMBER() OVER (ORDER BY busqueda_vivienda_informacionfinanciera.NumContrato) as row FROM busqueda_vivienda_informacionfinanciera WHERE Saldo <= 0 AND IdDelegacion=".$IdDelegacion."  ) a WHERE  Colonia='".$_GET['Col']."' 	Order by row";
                }
            }
