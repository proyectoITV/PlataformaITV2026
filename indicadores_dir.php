...
if (sanpedro($id_aplicacion, $nitavu)==TRUE)
{
    ...
    echo "<center>";
     echo "<div>";
        ...
        echo "<table style='width:80%;'>";
            ...
            echo "<tr>";
            echo '<td ></td>';            
            echo "<td><h2 style='font-size: 26px;'>BITÁCORA DE ACTIVIDADES RELEVANTES:</h2>";
            echo "</td></tr>";
        echo "</table>";
        echo "<br><br>";
    echo "</div>"; 
    echo "</center>";
     ...
     echo "<a style='right: 70px; position: absolute; top: 50px; margin-top: 10px;font-size: 12px;' href='reporte_indicadores.php?nitavu=".$nitavu."&idrep=1' class='Mbtn btn-danger' title='Imprimir actividades en pdf' class='btn btn-link'>
     Imprimir</a>";
    

     //// href='indicadores_actterminadas.php?nitavu=".$nitavu."'
//echo "<a style='right: 150px; position: absolute; top: 50px;' href='#HistorialActiv' rel='MyModal:open' title='Ver el historial de actividades' class='btn btn-link'>
...
if(isset($_GET['idactividad'])){
    ...
    echo '<th style="width:18%; color:black; background:white; border: 1px solid #B40404;  border-bottom: 2px solid #B40404;" rowspan="2"><center>ACTIVIDAD</center></th>';
    ...
    echo '<th colspan="2" style="width:13%; color:black; background:white; border: 1px solid #B40404;  border-bottom: 1px solid #B40404;"><center>PROGRAMA</center></th>';
    ...
    echo '<th style="width:10%; color:black; background:white; border: 1px solid #B40404;  border-bottom: 2px solid #B40404;" rowspan="2"><center>RESPONSABLE</center></th>'; ;

    echo '<th style="width:14%; background:#bc955c; color:black; border: 1px solid #B40404;  border-bottom: 2px solid #B40404;" rowspan="2"><center>OBSERVACIONES</center></th>';
    ...
    echo '</tr>';
    echo '<tr   style="font-size:7pt;">';    //bgcolor="#C0BDBD" //border:ridge;
...
$conexion->set_charset('utf8mb4');
        ...
        while($f = $r -> fetch_array()) {
          ...
          //  echo "<tr style='background-color: ".$color."'>";
                ...
                echo "<td><center><b>".$f['IdActividad'];              
                if(DireccionRealizoUltimoComentario($f['IdActividad'])=='TRUE' )
               {
                         echo "<a href='#modalMensaje".$f['IdActividad']."' onclick='ActualizarVisto(".$f['IdActividad'].",\"".$nitavu."\");' rel='MyModal:open' style='font-size:11px;'><img src='icon/mensaje.png' style='width:25px;'>";
                          /*MODAL   MENSAJE DIRECTOR*/
                          echo "<div id='modalMensaje".$f['IdActividad']."' class='MyModal' >"; 
                          echo " <a  rel='MyModal:close' class='close-modal' id='CerrarMensajeDir' name='CerrarMensajeDir'></a>";
                          echo "<div id='mensajeDirector' >"; 
              ...
              //  <a href='#modalHistorial".$f['IdActividad']."' rel='MyModal:open' style='font-size:12px;'>Historial actividades";
               ...
               ';
               if ($f['Estatus']!= 1 or (nitavu_dpto($nitavu)==1 or $nivel==2 )){ 
                ...
                */
                /*MODAL   avance*/
                   ...
                   //----
                //    echo '
                //     <p><label for="range_weight">Nuevo avance </label> <input type="range" name="avance" id= "avance"  class="slider" min="0" max="100" value="'.obtenerAvance($f['IdActividad']).'">
                ...
                echo "</div>";
                echo "</BR>";
                //echo "<input type='submit' value='Guardar' class='Mbtn btn-tercero' style='color:black' name='btnGuardar'>"; 
            ...
            // correcta echo "<td>".Fechaultimoavance($f['IdActividad'])."</td>";
            //echo "<td>". date_create(Fechaultimoavance($f['IdActividad']) )."</td>";
            ...
            echo "<td style='width:200px; font-size:12px'><center><b>".date_format(date_create(Fechaultimoavance($f['IdActividad'])), 'd-m-y')."</b></center></td>";
                ...
                /* echo "fa".Fechaultimoavance($f['IdActividad']);
                if (Fechaultimoavance($f['IdActividad']!="")){
            ...
            echo "<td><center><b>".porcentajeActividad($f['IdActividad'])." </b></center></td>";
                ...
                if((nitavu_dpto($nitavu)==1 or $nivel==2)|| RevisaEditaActividad($f['IdActividad'])==null){
               ...
               // $revisa=RevisaEditaActividad($f['IdActividad']);
                    ...
                    //echo "<a class='pc' href='#add' rel='MyModal:open' title='Editar la actividad'>";                    
                    ...
                    if(isset($_POST['btnGuardarM'])){
                        ...
                        //<textarea style='height:60px; font-size: 12; ' name='ncomentarios' >".$f['Comentarios']."</textarea>
                        echo "<td>
                    ...
                    echo "<img src='icon/eliminar.png' style='width:35px; padding:5px;'>";
                            ...
                            if(isset($_POST['btnGuardarElim'])){
                                ...
                                // echo "<td><label style='font-size: 13; '>Informe de gobierno</label></td>";
                                // echo "<td><select id='informegob' name='informegob' class='form-select' aria-label='Default select example'  style='width: 130px'>
                                //     <option value=1>1</option>
                                //     </select></td>";
                                ...
                                //echo "<td><input type='text' id='tema' name='tema' value = '".$f['Tema']."' disabled></td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td><label>Actividad</label><br></td>";
                                echo "<td><b><label style='height:60px;'>".$f['Actividad']."</label></b></td>";
                                //echo "<td><textarea style='height:60px;'; placeholder='Ingrese detalles del vehiculo' name='vactividad' >".$f['Actividad']."</textarea></td>";
                                echo "</tr>";
                                // echo "<tr>";
                                // echo "<td><label>Meta</label><br></td>";
                                // echo "<td><input type='number' id='meta' name='meta' value = '".$f['meta']."'></td>";
                                // echo "</tr>";
                                echo "<tr>";
                                ...
                                // echo "<tr>";
                                // echo "<td><label>Comentarios</label></td>";        
                                // echo "<td><textarea style='height:60px;'; name='ncomentarios' >".$f['Comentarios']."</textarea></td>";
                                // echo "</tr>";    
    ...
    echo "</div>";
       ...
       //<textarea style='height:60px; font-size: 12; '; name='vcomentarios' ></textarea>
        ...
        echo "</tr>";    
        echo "</table></center>";
        echo '<center><button type="submit"  name="btnGuardarA" id="btnGuardarA" class="btn btn-danger">Guardar</button>';                 
        echo "</form>";
        echo "</div>";
        }   
...
//      {
//          $(".close-modal").get(0).click();
//          location.href="indicadores_dir.php";
