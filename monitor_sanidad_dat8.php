...
$consulta = "
select sum(Saldo) as Valor from busqueda_vivienda_informacionfinanciera where IdDelegacion=".$IdDelegacion." and errores<=0 and IdPrograma NOT IN ( 240, 241 ) 
		AND Cancelado=0
";
...
if(is_array($array)){
     ...
     foreach ($array as $value) {
        if (isset($value['r'])){// si hay un error
            ...
            echo "<div id='Div".$IdDelegacion."_SCEIval' style='display:none;'>".$value['Valor']."</div>";   
