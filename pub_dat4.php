...
select 
    ...
    (
        ...
        WHERE
            ...
            AND  IdDelegacion = a.IdDelegacion
    ) as '2016',
...
from PadronDeBeneficiariosTAM_porDelegacion a
";
...
if(is_array($array2)){
    ...
    echo "<table class='tabla' width='400px;'>";
    echo "<th>Delegacion</th><th>2016</th><th>2017</th><th>2018</th><th>2019</th>";
    ...
    foreach ($array2 as $value2) {
        if (isset($value2['r'])){// si hay un error
            ...
            $strx = $strx."['".$value2['Delegacion']."',".$value2['2016'].", ".$value2['2017'].", ".$value2['2018']. ", ".$value2['2019']."],";
    ...
    ";
        ...
        var data = google.visualization.arrayToDataTable([
            ['Delegacion', '2016', '2017', '2018', '2019'],
            ".$strx."
        ...
        var options = {
            title: 'Estadistica por Año / Delegacion',
