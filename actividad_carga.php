...
if (isset($_GET['pagina']) and isset($_GET['id'])){
    ...
    while($f = $r -> fetch_array()) {
        ...
        $a = strpos($Descripcion, 'Aprobo'); if ($a !== false) {
            echo "<div id='actividad' style='background-color:#E3D79F; border: #A4A400 1px solid; color:white;'>";
            $x= 1;
        } 

        $em = strpos($Descripcion, 'Embarques'); if ($em !== false) {
            echo "<div id='actividad' style='background-color:#E3D79F; border: #006666 1px solid; color:#006666;'>";
            $x= 1;
        } 
