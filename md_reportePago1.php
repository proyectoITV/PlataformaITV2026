  ...
  class MYPDF1 extends TCPDF {
    ...
    public function Header() {
     ...
     // $this->Image($image_file, 10, 10, 45, 12, 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
      $this->Image($image_file, 10, 10, 70, 10, 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
...
$tabla3="";
$tabla3 = $tabla3.'<table>';
$tabla3 = $tabla3.'<tr><td align="right"></td></tr>';
$tabla3 = $tabla3.'<tr><td align="right"></td></tr>';
...
$tabla = "";
$tabla = '<span align="center"><b>RECUPERACIONES DE INGRESOS POR ABONO A LOS LOTES CORRESPONDIENTES';

if($resta == 0){
  $tabla = $tabla.' AL MES DE '.strtoupper($fecha).' DE '.$anio.'';
}else if($resta == 1){
  $tabla = $tabla.' A LOS MESES DE '.strtoupper($fecha).' Y '.strtoupper($fecha2).' DEL '.$anio.'</b> </span>';
}else{
  $tabla = $tabla.' A LOS MESES DE '.strtoupper($fecha).' A '.strtoupper($fecha2).' DEL '.$anio.'</b> </span>';
}
