...
if ($conexion->query($sql) == TRUE)
		...
		$contenido = "<p>
		Por medio de la presente se le comlib que se le han Actualizado los permisos de nivel ".$nivel." para la aplicacion ".app_nombre($idapp)." </p><p>
