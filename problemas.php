...
echo "<div id='Contenedorproblemas'>";
        ...
        echo "<div id='ContenedorListas'>";
            echo "<div id='Lproblemas'>";
                echo "Lista de problemas";
            echo "</div>";

            // echo "<div id='ListaDeActividad'>";
...
function problemasReload(){		                    
    $('#progressbar').show();
    LoaderDiv('Lproblemas');
    $.ajax({
    url: "problemas_dat_problemas.php",
    type: "post",        
    data: {},
    success: function(data){                
        $("#Lproblemas").html(data+"");     
