...
$id_aplicacion ="ap126"; $nivel = aplicacion_nivel($id_aplicacion, $nitavu);
...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    if (isset($_GET['NumContrato'])){
        ...
        echo '<h1 class="card-header h5">Registro de Subsidios Federal</h1>';
        $sqltc = " SELECT idtipomov,descripcionmovimiento FROM descripcionmovimiento where idtipomov in (9) ORDER BY descripcionmovimiento ";

       
            echo '<div class="card-body">';  
                echo "<form action='ajuste_historico4.php' method='GET'>";
                ...
                echo "<center>";
                    ...
                    echo "<input id='ref' name='ref' required>";

                    echo "<br><label>Responsable de captura <b>".nitavu_nombre($nitavu)."<input type='hidden' name='observaciones' id='observaciones' value='".nitavu_nombre($nitavu)."'></b></label><br>";
   ...
   if(isset($_GET['aprobar'])){
        ...
        if($importe > 0){
            ...
            WHERE (hp.TipoMov = 9 ) and (hp.NumContrato = '".$NumContrato."' ) and (hp.Cancelado=0)";
            echo $sql;
            ...
            if($rows>0){
                ...
                RegistraaCapital($NumContrato,$convenio,$observaciones,$cargo,$fecha,$importe,$ref,'3', $IdDelegacion, $IdPrograma, $Folio, $nitavu, 'ajuste_historico4.php');
            }
        }
    }
