...
?>
<?php
$id_aplicacion ="ap46"; //Id de la aplicacion a cargar
...
//grafica transpaso
               ...
               select 
                     ...
                     (select count(*) from notificadores_visitas where transpaso=1  and  visitada='TRUE' AND vobo<>'') as Transpasos,
                     (select count(*) from notificadores_visitas where transpaso=2  and  visitada='TRUE' AND vobo<>'') as NOtranspasos,
                     (select count(*) from notificadores_visitas where transpaso=3  and  visitada='TRUE' AND vobo<>'') as SinEntrevistar
           ...
           //         ['Sleep',    7]
               ...
               echo "<h3>Entrevistas sobre  Traspasos</h3>";
               ...
               chart.draw(data, options);
                 ...
                 <div id='chart_top8' style='width: 100%; height:50%; background-color:white;' ></div>";
                echo $grafica8;
   ...
   //grafica transpaso
               ...
               select 
                     count(*) as total_visitados,
                     (select count(*) from notificadores_visitas where transpaso=1  and  visitada='TRUE' AND vobo<>'' AND id_municipio='".$_GET['m']."') as Transpasos,
                     (select count(*) from notificadores_visitas where transpaso=2  and  visitada='TRUE' AND vobo<>'' AND id_municipio='".$_GET['m']."') as NOtranspasos,
                     (select count(*) from notificadores_visitas where transpaso=3  and  visitada='TRUE' AND vobo<>'' AND id_municipio='".$_GET['m']."') as SinEntrevistar

               FROM
                     notificadores_visitas
               WHERE visitada='TRUE'
                     AND vobo<>''
                     AND notificadores_visitas.id_municipio = '".$_GET['m']."'
           ...
           //         ['Sleep',    7]
               ...
               var chart = new google.visualization.PieChart(document.getElementById('chart_top9'));
               chart.draw(data, options);
                  }
                  </script>
                 <div id='chart_top9' style='width: 100%; height:50%; background-color:white;' ></div>";
                echo $grafica9;
           ...
           //         ['Sleep',    7]
               ...
               echo "</table>";
               echo "<br>";
               echo "<a class='Mbtn btn-tercero' href='notificadores_transpasos.php?m='>Ver todo el estado </a>";
