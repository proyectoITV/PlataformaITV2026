...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    echo "<span><br><input type='submit' name='btn_historia' value='Consultar' class='Mbtn btn-secundario' style='color:white;'></span>";
    ...
    while($f = $r -> fetch_array()) {
        ...
        $Resultados = $Resultados."<tr style='background-color:#E3D79F;'>";} 
