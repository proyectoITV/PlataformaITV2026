...
$IdDesarrollador=VarClean($_POST['VIdDesarrollador']);
...
if ($IdDesarrollador == ''){
    ...
    $sql="UPDATE catdesarrolladores SET     
    Nombre = '".$Nombre."',
    Representante_Legal = '".$VRepresentante."',
    CURP = '".$VCURP."',
    RFC = '".$VRFC."',
    Telefono = '".$VTelefono."',
    DomicilioFiscal = '".$VDomicilio."',
    Contacto_Empresa = '".$VContacto."',
    CorreoElectronico = '".$VCorreo."',
    TelContacto='".$VTelContacto."',
    IdEmpModifica=".$nitavu.",
   ...
   //echo $sql;
    ...
    if ($Vivienda->query($sql) == TRUE) {
        ...
        Toast("Error al Guardar cambios del Desarrollador ".$Nombre."",2,"");
    }
    unset($sql,$resultado);
}
