...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    if (isset($_GET['id'])){
        ...
        if($V = $r -> fetch_array())
        {
          ...
          echo "<h3 style='color:black;'>HISTORIAL DE ACCIONES</h3>";
            ...
            while($f = $r -> fetch_array()) {
                ...
                echo "<td>".$f['Fecha']."</td>";
                echo "<td>".$f['Tipo']."</td>";
                echo "<td><a class='btn btn-success' title='Haz clic aqui para descargar' style = 'background-color: #ddc9a3; border-color: #ddc9a3; box-shadow:0 3px #bc955c;' href='".$f['file_url']."' download='".EasyName("",6)."'><img src='icon/download-from-cloud.png' style='width:18px; cursor:pointer;'>"."</a></td>";
                echo "</tr>";
            }
            echo "</table>";
            unset($r,$f,$sql);
