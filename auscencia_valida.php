...
if ($hr_regreso<$hr_salida) {
		mensaje ("VERIFICA!, la hora de regreso que estas indicando ".$hr_regreso." es menor que la de salida.".$hr_salida,'');
}
else {
...
$sql1="INSERT INTO empleados_salidas_temporal
		...
		VALUES
		('$nitavu', '$hr_salida', '$hr_regreso', '$justificacion', '$dia1', '$hora','$asunto', '$fecha_','$dpto');";
...
$sql2="INSERT INTO empleados_salidas_temporal
		(nitavu, hora_desde, hora_hasta, justificacion, solicito_fecha, solicito_hora,  asunto, fecha, dpto)
		VALUES
		('$nitavu', '$hr_salida', '$hr_regreso', '$justificacion', '$dia2', '$hora','$asunto', '$fecha_','$dpto');";
...
$sql3="INSERT INTO empleados_salidas_temporal
		(nitavu, hora_desde, hora_hasta, justificacion, solicito_fecha, solicito_hora,  asunto, fecha, dpto)
		VALUES
		('$nitavu', '$hr_salida', '$hr_regreso', '$justificacion', '$dia3', '$hora','$asunto', '$fecha_','$dpto');";
...
$sql4="INSERT INTO empleados_salidas_temporal
		(nitavu, hora_desde, hora_hasta, justificacion, solicito_fecha, solicito_hora,  asunto, fecha, dpto)
		VALUES
		('$nitavu', '$hr_salida', '$hr_regreso', '$justificacion', '$dia4', '$hora','$asunto', '$fecha_','$dpto');";
...
$sql5="INSERT INTO empleados_salidas_temporal
		(nitavu, hora_desde, hora_hasta, justificacion, solicito_fecha, solicito_hora,  asunto, fecha, dpto)
		VALUES
		('$nitavu', '$hr_salida', '$hr_regreso', '$justificacion', '$dia5', '$hora','$asunto', '$fecha_','$dpto');";
...
$sql = "INSERT INTO empleados_salidas_temporal
		(nitavu, hora_desde, hora_hasta, justificacion, solicito_fecha, solicito_hora,  asunto, fecha, dpto)
		VALUES
		('$nitavu', '$hr_salida', '$hr_regreso', '$justificacion', '$fecha', '$hora','$asunto', '$fecha_','$dpto');";
