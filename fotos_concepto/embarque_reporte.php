...
if (guia_proveedor($guia)=='1'){
    ...
    $instrucciones = "
    <h5>INSTRUCCIONES PARA REGISTRAR RECEPCION</h5>
    <ol>
    ...
    mensaje("ERROR: No esta configurado el reporte para este proveedor, Disculpe las molestias. Comunicarse a soporte ",'embarques.php');
}
...
function validar_guia($guia, $usuario){require("unica/config.php");
