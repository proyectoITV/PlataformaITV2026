...
if (isset($_GET['id'])){//el usuario selecciono un empleado
	...
	echo "<div>";
		echo "<input type='submit' value='ENVIAR' class='btn btn-default'>";
	echo "</div>";

	echo "<div>";
		echo "<a href='documentar.php' class='btn btn-secundario'><img src='icon/home.png' style='width:21px; height:21px;'></a>";
	echo "</div>";
