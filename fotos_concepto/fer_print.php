...
if($f = $rc -> fetch_array())
{
    ...
    $pdf->SetXY(0, 0);
    $pdf->Image('img/pdf_logo.jpg', '5', '5', 100, 20, '', '', 'T', false, 00, '', false, false, 0, false, false, false);    
    ...
    $pdf->Text(84, 224, "__________________________________");
    $pdf->SetFont('', 'B', 10, '', 'false');
    $pdf->Text(84, 228, nitavu_nombre(CATgerarquia_director()));
    $pdf->SetFont('', 'R', 10, '', 'false');
    $pdf->Text(97, 231, "Director General");
    ...
    $url = $urlsite.'https://plataformaitavu.tamaulipas.gob.mx/fer_valida.php?id='.$_GET['print'];
    ...
    mensaje ("ERROR: certificado no valido",'fer.php');
}
