...
<script>
    ...
    function enviarDatos(){
        ...
        $.ajax({
            ...
            derechos: derechos, signo7: signo7, pagoDerechos: pagoDerechos, centavo: centavo, idTipoMov:idTipoMov },
            success: function(data){
...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    if(isset($_GET['idmandante']) and isset($_GET['idcolonia']) and isset($_GET['idmunicipio'])  ){
       ...
       /* if(isset($_POST['numoficio'])){
        ...
        if(isset($_POST['fechaMan'])  and isset($_POST['superficie']) and isset($_POST['costoLotes'])){
            ...
            $totLotesL, $lotesConL, $lotesSinConL, $totLotesS, $lotesConS, $lotesSinConS, 1,$lotesareav, $loteseq, $reserva, $observaciones);
        ...
        if(isset($_POST['fechaAdendum']) and isset($_POST['fechaAdendumFiniquito'])){
            $fechaman = "";
            //$fechatri = $_POST['fechaTri'];
            ...
            $fechaAdendum, $fechaAdendumFiniquito, $plazoCredito, $costoLotes, $LoteM2, $superficie,
            $supComercializar, $porMan, $porItavu, $monpagar, $monpagarComer, 
            $totLotesL, $lotesConL, $lotesSinConL, $totLotesS, $lotesConS, $lotesSinConS,2,$lotesareav, $loteseq, $reserva, $observaciones);
        ...
        if(isset($_GET['idpago'])){
            ...
            $mas_menos5,$escritura, $mas_menos6,$derechos,$mas_menos7,$pagoDerechos,$centavo, $comentario, $nitavu);
        ...
        echo "<center><div>"; 
            echo "<a  href='md_lista.php' title='Clic para ver lista de mandantes' class='btn btn-default'>";
        ...
        echo "<div name='Mandantes' id='Mandantes'>";
            $sql3 = "SELECT * FROM cat_mandantes WHERE IdColonia = ".$idcolonia." and IdMunicipio=".$idmunicipio."";
        ...
        echo "<div name='Apoderado' id='Apoderado'>";
            $sql4 = "SELECT Mandante FROM cat_mandantes WHERE IdColonia = ".$idcolonia." and IdMunicipio=".$idmunicipio."  and IdMandante=".$idmandante." ORDER BY Mandante ASC";
        ...
        echo "<div id='req_menu' style='display:inline-block;'>"; 
            echo "<a href='#registroPago' rel='modal:open' class='btn btn-default' title='Clic para registrar un nuevo pago'>";
            ...
            echo '<a id="reporteMandante" href="md_reporte.php?id='.$idmandante.'&idcolonia='.$idcolonia.'&idmunicipio='.$idmunicipio.'" class="btn btn-default"  title="Clic para ver el reporte">';
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            ...
            echo "<a id='nuevoCargo' href='md_nuevoCargo.php?id=".$idmandante."&idcolonia=".$idcolonia."&idmunicipio=".$idmunicipio."' class='btn btn-default' title='Clic para capturar un cargo'>";
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            ...
            echo "<a id='mddocumentos' href='md_documentos.php?id=".$idmandante."&idcolonia=".$idcolonia."&idmunicipio=".$idmunicipio."' class='btn btn-default' title='Clic para agregar documentos al mandante'>";
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            echo "<img src='icon/cargo.png' style='width:30px; height:30px;'>";
            echo "</td>";
            echo "<td valign='middle' align='center' style='color:white;' class='pc'>";
       ...
       //Ingresar datos
        echo "<center>";
        echo "<div id='registroPago' class='modal' style='width:70%; display:none;'>";
           ...
           //  echo '<form name="formulario" onSubmit="enviarDatos();" >';
                ...
                echo "<div>";
                    ...
                    echo "<input type='number' step='any' placeholder='$0.00' onblur='mostrarDecimales()' name='recuperacion' id='recuperacion' required>";
                echo "</div>";
                echo "<div>";
                    echo "<table style='width:100%;'>";
                        echo "<td>";
               ...
               echo "<div>";
                    echo "<table style='width:100%;'>";
                        echo "<td>";
                            echo "<label style='text-align:center;'>%</label>";
                            echo "<input type='number' step='any' placeholder='%' name='pdevols' id='pdevols' required>";
                        echo "</td>";
                        echo "<td>";
                            echo "<label>Devoluciones</label>";
                            echo "<input type='number' step='any' placeholder='$0.00' name='devols' id='devols'>";
                        echo "</td>";
                    echo "</table>";
                echo "</div>";
                ...
                echo "<div>";
                    echo "<table style='width:100%;'>";
                        echo "<td>";
                            echo "<label style='text-align:center;'>%</label>";
                            echo "<input type='number' step='any' placeholder='%' name='pamorAnt' id='pamorAnt' required>";
                        echo "</td>";
                        echo "<td>";
                ...
                echo "<div>";
                    ...
                    echo "<input type='number' step='any' placeholder='$0.00' name='montoPagado' id='montoPagado' required>";
                echo "</div>";
                echo "<div>";
                ...
                echo "<div>";
                    ...
                    echo "<input type='number' step='any' placeholder='$0.00' name='sistema' id='sistema' required>";
                echo "</div>";
                 echo "<div>";
                    echo "<table style='width:100%;'>";
                        echo "<td>";
                ...
                echo "<div>";
                    echo "<table style='width:100%;'>";
                        ...
                        echo "</td>";
                        echo "<td>";
                            echo "<label  style='text-align:center;'>Por enganche de ahorro</label>";
              ...
              echo "<div>";
                ...
                //echo "</div>";
                echo "<div>";
                    echo "<input class='btn btn-default' type='submit' id='guardar' value='Guardar' >";
                echo "</div>";
           ...
           //  echo '<form name="formulario" onSubmit="enviarDatos();" >';
                ...
                echo "<div>";
                    echo "<label>Monto pagado</label>";
                    echo "<input type='number' step='any' placeholder='$0.00' name='montoPagado2' id='montoPagado2' required>";
                echo "</div>";  
                echo "<div>";
                    echo "<label>Monto acumulado</label>";
    ...
    if ($rc->num_rows>0){
        ...
        while($r = $rc -> fetch_array()){
            ...
            //onclick='seleccionarMODAL('subirAdjuntos1".$vuelta."')'
                //echo "<a href='#subirAdjuntos' rel='modal:open' onclick='pasarIdConsulta(".$r['id'].','.$idmandante.','.$idcolonia.','.$idmunicipio.")' title='Haga click aqui para subir archivos'>Adjuntos_".$r['id']."</a>";
...
/*-------------------------------------------------------------------------------------------------------------------------*/
        ...
        echo "<div id='req_menu' style='display:none;'>"; 
            echo "<a href='#registroPago' rel='modal:open' class='btn btn-default' title='Clic para registar pago'>";
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            echo "<img src='icon/pago.png' style='width:30px; height:30px;'>";
            echo "</td>";
            echo "<td valign='middle' align='center' style='color:white;' class='pc'>";
            ...
            echo "</a>";	
                //target="_blank"
            MiToken_Init($nitavu, 'PAGO A MANDANTES-ORDEN DE PAGO'); // inicializamos seguridad del Token (no necesitamos saberlo)
            echo '<a id="reporteMandante" href="md_reporte.php"  class="btn btn-default"  title="Clic para ver el reporte">';
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            echo "<img src='icon/pdf.png' style='width:30px; height:30px;'>";
            echo "</td>";
            echo "<td valign='middle' align='center' style='color:white;' class='pc'>";
            ...
            echo "<a id='nuevoCargo' href='md_nuevoCargo.php' class='btn btn-default' title='Clic para registrar cargo'>";
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            echo "<img src='icon/cargo.png' style='width:30px; height:30px;'>";
            echo "</td>";
            echo "<td valign='middle' align='center' style='color:white;' class='pc'>";
            ...
            echo "<a id='mddocumentos' href='md_documentos.php' class='btn btn-default' title='Clic para agregar documentos al mandante'>";
            echo "<table  width='100%'><tr><td valign='middle' align='center'>";
            echo "<img src='icon/cargo.png' style='width:30px; height:30px;'>";
            echo "</td>";
            echo "<td valign='middle' align='center' style='color:white;' class='pc'>";
