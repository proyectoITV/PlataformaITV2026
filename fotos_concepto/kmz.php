...
historia ($nitavu,"Entro a ver las Reservas Territoriales (app: ".$id_aplicacion.")");
	...
	<div id='grafica'><div id='chart_div'></div></div>
		...
		if ($intento == "SI"){
			...
			<br><br>
			<a href='kmz.php?m=' class='btn btn-default'>Regresar</a>
			<a href='kmz_reg.php?m=".$_GET['m']."' class='btn btn-default'>Ver Regularizado</a>
			";

			if (isset($_GET['aeropuerto'])){
				echo  "<a href='kmz.php?m=".$_GET['m']."' class='btn btn-cancel'>Quitar Proyecto Aeropuerto</a>";
			} else {
				echo  "<a href='kmz.php?m=".$_GET['m']."&aeropuerto=' class='btn btn-secundario' style='color:white;'>Ver Proyecto Aeropuerto</a>";
			}
