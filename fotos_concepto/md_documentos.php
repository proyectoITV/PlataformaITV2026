          ...
          while($r = $rc -> fetch_array()){
            echo "<tr>";
              ...
              if($r['nitavusube']==$nitavu) {
                ...
                echo "<button style='width:30px; height:25px;' class='btn btn-cancel' type='submit' title='Haga clic para eliminar el archivo'> <img src='icon/delete.png' style='width:10px; height:10px;'> </button>";
