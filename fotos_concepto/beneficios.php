...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    echo "<a class='btn btn-default' href='beneficios.php?busqueda=ITAVU'>Ver coincidencias entre Beneficiarios con empleados de ITAVU</a>";
    ...
    if (isset($_GET['Beneficiario'])){
        ...
        while($f = $r -> fetch_array()){
            ...
            //  echo "<a href='beneficios.php?Beneficiario=".$f['Beneficiario']."' class='btn btn-default'> > </a>";
            echo "</td>";
    ...
    if (!isset($_GET['busqueda']) and !isset($_GET['Beneficiario'])){
	    ...
	    $grafica2 = "
        <script type='text/javascript' src='unica/gstatic_loader.js'></script>
