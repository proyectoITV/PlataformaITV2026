...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
	...
	echo "<form action='asistencia.php' method='post' class='cuadro'>";
	...
	echo "<div>";
	echo "<input type='submit' value='Agregar empleado a control de asistencia' class='btn btn-default'>";
	echo "</div>";
...
if (isset($_POST['empleado'])){
	...
	echo "<div>";
		...
		echo "<input type='submit' name='' value='Consultar' class='btn btn-default'>";
		echo "</div>";	
