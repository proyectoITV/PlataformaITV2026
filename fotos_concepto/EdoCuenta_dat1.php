...
error_reporting(0); //<-- para simular produccion
 ...
 //Parametros
 if ( isset($_GET['IdDelegacion']) and isset($_GET['NumContrato']) ){
        // echo ":)".$nitavu;
        $contrato =  (string) $_GET['NumContrato'];
        echo $_GET['NumContrato'];
        $IdDelegacion = (string) $_GET['IdDelegacion'];
        ...
        FROM Vivienda_InformacionContratosTodos WHERE numcontrato = '".$contrato."'";

    // echo $sql;
                $ConsultaDATA = DatosViviendaLarge($IdDelegacion, "WSContratos", "Test", $sql);
                $array = json_decode($ConsultaDATA, true);
                //<td border="1" bgcolor="#A2C30D" align="right" >Fecha de contrato: </td>                      
                ...
                if(is_array($array)){            
                    foreach ($array as $value) {
                        if (isset($value['r'])){// si hay un error
                            ...
                            echo "<div style='width: 40%; border: 2px solid #FFFF0F; display: inline-block; background-color: #FFFFBF; border-radius: 10px; margin: 10px; padding: 10px;'>";
                                ...
                                echo "<td align='center'  valign='middle' style=' color: #FF9900;  font-family: Verdana;'>No se ha encontrado información sobre este contrato: ".$contrato.", ".$value['r'].$ConsultaDATA."</td>";
                                echo "</tr>";
                                echo "</table>";
                            echo "</div>";
                            echo "</center>";
                            ...
                            <table frame="above">
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td bgcolor="#A2C30D" align="right">Delegación:</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                            <td bgcolor="#A2C30D" align="right">Número contrato: </td>
                            ...
                            <table>
                                <tr>
                                    <td border="1" bgcolor="#005BA0" style="color:white; height:5px; border-top-right-radius:10px; border-top-left-radius: 10px;">
                                    ...
                                    <td>
                                        <table frame="below">
                                            <tr>
                                            <td bgcolor="#A2C30D" align="right" >Fecha de contrato: </td>
                                ...
                                // echo $sql2.'<br>';
                                    ...
                                    <table>
                                        <tr>
                                            <td border="1" bgcolor="#005BA0" style="color:white; height:5px; border-top-right-radius:10px; border-top-left-radius: 10px;">  DATOS DEL CONTRATO </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                        ...
                        CASE WHEN HistoricoPagos.SaldoCapitalCorriente + HistoricoPagos.Saldoexento + HistoricoPagos.NuevoRezCapital + HistoricoPagos.NuevoRezFinanc + HistoricoPagos.NuevoRezMoratorios + HistoricoPagos.NuevoRezOtrosGts + HistoricoPagos.NuevoRezSeg + HistoricoPagos.NuevoRezGts = 0 THEN ''
                            ...
                            $t1 = $t1.'<tr><td colspan="8" bgcolor="#005BA0" align="center" border="1" style="color:white;" >Resumen de Movimientos</td></tr>';
                            $t1 = $t1."</tbody>";
                            $t1 = $t1."</table></div>";
                            $t1 = $t1."<br><br>";
                            $t1 = $t1."<table>";
                            $t1 = $t1."<tr>";
                                $t1 = $t1.'<td bgcolor="#005BA0" align="center" border="1" style="color:white; width:215px;"> Cargos</td>';
                                $t1 = $t1.'<td style="width:7px;"></td>';
                                $t1 = $t1.'<td bgcolor="#005BA0" align="center" border="1" style="color:white; width:215px;"> Abonos</td>';
                                $t1 = $t1.'<td style="width:7px;"></td>';
                                $t1 = $t1.'<td bgcolor="#005BA0" align="center" border="1" style="color:white; width:215px;"> Saldo</td>';
                            $t1 = $t1."</tr>";
                    ...
                    echo "<center>";
                        echo "<div style='width: 40%; border: 2px solid #FFFF0F; display: inline-block; background-color: #FFFFBF; border-radius: 10px; margin: 10px; padding: 10px;'>";
                            ...
                            echo "<tr>";
                            echo "<td width='50px' align='left' valign='middle'><img src='icon/404.png'></td>";
                            echo "<td align='center'  valign='middle' style=' color: #FF9900;  font-family: Verdana;'>Ocurrio un error al momento de recibir la información de Vivienda, Favor de comunicarse con el dpto. de informática.</td>";
                            echo "</tr>";
                            echo "</table>";
                        echo "</div>";
                    echo "</center>";
