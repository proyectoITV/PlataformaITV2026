...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    if (isset($_GET['sol'])){
        ...
        while($f = $r -> fetch_array()) {
            ...
            echo "<td>";
            if ($f['Autorizo'] == ''){
                echo "<a href='?eu=".$f['nitavu']."' class='btn btn-default'>Autorizar</a>";
    ...
    while($f = $r -> fetch_array()) {
        if ($nivel == 1 ) {
                if ($f['DptoID']=='*'){
                    ...
                    echo "<td>";
                    echo "<button class='btn btn-default'>Guardar</button>";
                    echo "</td>";
    ...
    echo "<a href='horario.php?sol=' class='btn btn-tercero' style='color:black'>Aprobar accesos extratemporales</a>";
    echo "<br><br><br>";
    }
