...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    if ( isset($_GET['IdDelegacion']) and isset($_GET['IdPrograma']) and isset($_GET['Saldo']) and isset($_GET['Moratorios'])  and isset($_GET['Fora'])){
        ...
        $str_loader = "<img src='img/loader110.gif' style='width:50px;'><br> <label style='font-size:7pt; color:orange;'>Leyendo Base de Datos desde las Delegaciones...</label>";
            ...
            font-weight: bold;
            color: white;
            font-family: ExtraBold;' class='btn btn-tercero' id='btnSinSaldo'><a href='contratos.php?IdDelegacion=".$IdDelegacion."&IdPrograma=".$IdPrograma."&Saldo=0&Moratorios=0&Fora=1' title='Haga clic aqui para ver Todos los Contratos Foraneos'>Foraneos</a></button> ";
            echo "<button title='Haga clic aqui para mostrar todos los contratos sin saldo' style = 'padding: 3px;
            height: 41px;
            vertical-align: top;
            font-weight: bold;
            color: white;
            font-family: ExtraBold;' class='btn btn-tercero' id='btnSinSaldo'><a href='contratos.php?IdDelegacion=".$IdDelegacion."&IdPrograma=".$IdPrograma."&Saldo=0&Moratorios=0&Fora=0' title='Haga clic aqui para ver Todos los Contratos sin Saldo'>Sin Saldo</a></button> ";
            echo "<button title='Haga clic aqui para mostrar todos los contratos sin saldo' style = 'padding: 3px;
            height: 41px;
            vertical-align: top;
            font-weight: bold;
            color: white;
            font-family: ExtraBold;' class='btn btn-tercero' id='btnConSaldo'>";
            ...
            echo "<button title='Haga clic aqui para mostrar todos los contratos' style = 'padding: 3px;' class='btn btn-tercero' id='btntodos' onclick='Contratos(3);'><img src='icon/reportes.png' style='padding: 3px; width:30px; height:30px;'></button> ";
            echo "<button title='Haga clic aqui para regresar 10 contratos atras' style = 'padding: 3px;' class='btn btn-secundario' id='btnleft' onclick='Contratos(2);'><img src='icon/btn_izquierda.png' style='padding: 3px; width:30px; height:30px;'></button> ";
            echo "<button title='Haga clic aqui para avanzar viendo los contratos' style = 'padding: 3px;' class='btn btn-secundario' id='btnright' onclick='Contratos(1);'><img src='icon/btn_derecha.png' style='padding: 3px; width:30px;'height:30px;></button> ";
