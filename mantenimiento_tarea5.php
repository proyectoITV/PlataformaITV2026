<?php
 ...
 $txtFull = "";
    ...
    $Hora1 = "05:10:00.0000";   $Hora2 = "08:00:00.0000";    //Ventana de Accion
    if ( ($hora>= $Hora1) and ($hora <=$Hora2) ) {
        echo "Horario Ideal";    
        Tarea("2", "Envio Resumen Ticket Tarde", FALSE); //agrega la tarea
            ...
            while($f = $r -> fetch_array()) {
                ...
                $txtFull = $txtFull.$txtBody;
                $txtBody = "";
            }

            // echo $txtBody;
                Tarea("2", "Envio Resumen Ticket Tarde", TRUE); //Se actualiza la tarea
    ...
    if ($txtFull <> ''){
                        ...
                        $quien = "informatica.itavu@gmail.com";
                        $quien_nombre = "Plataforma ITAVU";
                        $asunto = "Resumen de Total de Pendientes Tickets".$fecha.":".$hora;
                        $contenido = "".$txtFull;
                        $usuario = "2809";
                        correo(nitavu_correo($usuario), nitavu_nombre($usuario), $quien, $quien_nombre, $asunto, $contenido, $usuario);
