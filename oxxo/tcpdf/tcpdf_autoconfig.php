...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'tamaulipas.jpg')) {
		$tcpdf_header_logo = 'tamaulipas.jpg';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'GOBIERNO DEL ESTADO DE TAMAULIPAS');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "INSTITUTO TAMAULIPECO DE VIVIENDA Y URBANISMO");
}
