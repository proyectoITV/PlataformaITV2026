...
Delegacion, 
NombreCompleto,
NumContrato, MontoCredito, IdDelegacion
...
$consulta = "
select * from BeneficiariosTAM Where IdPrograma=".$IdPrograma."
";
...
FROM
	(
		...
		from BeneficiariosTAM Where IdPrograma=".$IdPrograma."
...
// echo $consulta;
$ConsultaDATA = DatosViviendaLarge(0, $nitavu, "PUBx", $consulta);
...
if(is_array($array)){
    ...
    <caption> Lista de Beneficiarios de ITAVU de esta Administracion(1/oct/2016 a la fecha) del Programa IdPrograma='.$IdPrograma.'</caption> ';
    ...
    echo "</table>
    <button class='Mbtn btn-default' onclick='PorPrograma(".$IdPrograma.");'>Mas...</button>
    ";

    echo "<hr>";
    
    ExportarExcel($ExcelTabla, "BeneficiariosTamPorPrograma".$IdPrograma, $nitavu);
    //TOTAL
}
