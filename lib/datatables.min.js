...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "No se han encontrado resultados" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "Siguiente", sPrevious: "Anteriores" },
