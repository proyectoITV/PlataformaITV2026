...
//echo nitavu_direccion($nitavu); // direccion del usuario logeado, o del que este al alcance del no. de itavu
...
//echo "<a href='' class='Mbtn btn-default'> Soy un Boton Vinculo modo Default </a>";
//echo "<input type='submit' class='Mbtn btn-cancel' Value='Soy un Boton input Submit modo ALERTA'>"; // El tamaño esta determinado por el formulario cuando se incluya en un form, dentro de divs tomara la forma y se ajustara al formulario
...
//echo "<button class='Mbtn btn-secundario' onclick=location.href=''>";
...
// echo "<div id='AppDetalle'> Soy un H5 </div>";
...
// echo "<div>";
// 	echo "<input type='submit' class='Mbtn btn-default' value='Guargar'>";
// echo "</div>";
