...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
      ...
      if (isset($_POST['fechabuscada'])){
            ...
            echo" <div><input type='submit' name='btbusca' value='Buscar' class='Mbtn btn-default' ></div>";
      ...
      mensaje("ERROR: no tienes acceso a esta aplicacion. Comlibte con el Dpto. de Informatica",'');
}
?>
