...
echo "<div id='AppDetalle'>".app_detalle($id_aplicacion, $nitavu)."</div>";
  ...
  if(isset($_POST['mandante']) ){
    ...
    $sql = 'UPDATE cat_mandantes SET Propietarios="'.$propietario.'", Mandante="'.$mandante.'", RepresentanteLegal="'.$representante.'" WHERE IdMandante='.$idmandante.' and IdColonia='.$idcolonia.' and IdMunicipio='.$idmunicipio.'';
    echo $sql;
  ...
  if (isset($_GET['busqueda'])){//Que hacer si esta buscando
    ...
    from mandantes
    WHERE Mandante like'%".$_GET['busqueda']."%' OR ReresentanteLegal like '%".$_GET['busqueda']."%' OR Propietarios like '%".$_GET['busqueda']."%' and Cancelado=0
    ORDER BY Mandante";

    $sql="SELECT * FROM cat_mandantes
    WHERE cat_mandantes.Propietarios like '%".$_GET['busqueda']."%' OR cat_mandantes.Mandante like '%".$_GET['busqueda']."%' and Cancelado=0
    ORDER BY Mandante";
    ...
    if ($rc->num_rows>0)
    {
      ...
      {
        $vuelta++;
        echo "<div id='resultado_elemento' style='width:80%' >";		
        echo "<table border='0'>";
				echo "<tr>";													
						...
						echo "<tr>";							
						echo "<td>";
						echo "<span class='normal tmediano'>".$r['Mandante']."</span>";
						echo "<span class='pc tchico'><br>Representane Legal (s): ".$r['RepresentanteLegal']."</span>";
						echo "</td>";
						echo "</tr>";
						echo "</table>";
						echo "</td>";	
      ...
      echo "<br>";
      echo "<a class='Mbtn btn-default' href='mandantes.php'>Buscar nuevamente</a>";
      echo "</center>";
    } else {
