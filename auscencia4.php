...
<table width="100%" border="0" style='font-size: 11pt; color:gray;'>
  ...
  <tr>
    ...
    <td><input type='submit' name='submit_pases' class='Mbtn btn-default' value='Solicitar'></td>
  </tr>
</table>
 </form>
...
if ($conexion->query($sql) == TRUE)
	{
			...
			// notificacion_add (titular(nitavu_dpto($nitavu)), '', $fecha, $nitavu, $m); //<-- solo notificacion
