...
//CONTRATOS CON ERRORES sin errores
...
$consulta = "
select count(*) as Valor from busqueda_vivienda_informacionfinanciera where IdDelegacion=".$IdDelegacion." and errores<=0 and IdPrograma NOT IN ( 240, 241 ) 
	AND Cancelado=0
";
