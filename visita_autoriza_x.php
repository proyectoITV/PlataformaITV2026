...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
	...
	$sql="UPDATE visitas SET autorizo_nitavu='$nitavu', autorizo_fecha='$fecha', autorizo_hora='$hora', rechazado='TRUE' WHERE (id='$id')";
	if ($conexion->query($sql) == TRUE)
			{
			mensaje ("Visita RECHAZADA Correctamente",'visitas.php');
