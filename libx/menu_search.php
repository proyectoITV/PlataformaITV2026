...
from _SearchPermisos a where IdEmpleado = ".$nitavu." order by Label
...
while($fc = $rc -> fetch_array())
{
        ...
        *
        ...
        {//Categorias de Aplicaciones
            ...
            <a href='".$fap['URL']."' style='display:block;' title='".$fap['Title']."'><img class='MisApps_Icon'src='icon/".$fap['Icono']."' ></a></td>";
            echo "<td >";
            
            echo "<span  title='".$fap['Title']."' style='font-size:8pt; cursor:pointer;'> <a style='display:block; color:black; width:100%; height:200%;' href='".$fap['URL']."'>".$fap['Label']."</a></span>";
...
if ($mode == 1){
    ...
    {//Categorias de Aplicaciones
        ...
        if ($fap['Permiso']==1){
            $DivApps.= "<a href='".$fap['URL']."' style='display:block;' title='".$fap['Title']."'>";
        }
        ...
        if ($fap['Permiso']==1){
            $DivApps.= "<a style='display:block; color:black; width:100%; height:200%;' href='".$fap['URL']."'>".$fap['Label']."</a>";
        } else {
            $DivApps.= "".$fap['Label']."";
        }
        $DivApps.= "</span>";
    ...
    {//Categorias de Aplicaciones
        ...
        echo "<td align=center class='MisApps_backgroundIcon'>";
        if ($fap['Permiso']==1){
            echo "<a href='".$fap['URL']."' style='display:block;' title='".$fap['Title']."'>";
        }
        ...
        if ($fap['Permiso']==1){
            echo "<a style='display:block; color:black; width:100%; height:200%;' href='".$fap['URL']."'>".$fap['Label']."</a>";
        } else {
            echo $fap['Label'];
        }
        echo "</span>";
...
if ($mode == 2){
    PreferenceUpdate('VistaMenu', $nitavu, '',2);
            ...
            *
            ...
            {//Categorias de Aplicaciones
                echo "<article>";
                echo "<a href='".$fap['URL']."' style='display:block;' title='".$fap['Title']." - ".$fap['Label']."'>";
...
if ($mode == 4){
    PreferenceUpdate('VistaMenu', $nitavu, '',4);
            ...
            *
            ...
            color: #ffebd0;
            font-size:13pt;
            '><b style='color:#cc8c12; margin-left:10px;' class='pc'>Mis Apps Favoritas: </b></h1>";
            echo "<div id='app_iconos'>";
            $r = $conexion -> query($sql);
            while($fap = $r -> fetch_array())
            {//Categorias de Aplicaciones
