 ...
 if ( isset($_GET['IdDelegacion']) and isset($_GET['Hasta']) and isset($_GET['Desde']) and isset($_GET['Col']) ){
      ...
      case "sindeuda":
          ...
          FROM
              ...
              SELECT
                  ...
                  ROW_NUMBER ( ) OVER ( ORDER BY busqueda_vivienda_informacioncontratos.NumContrato ) AS row 
              FROM
                  busqueda_vivienda_informacioncontratos 
              WHERE
  ...
  if ($IdPrograma <> ''){
    ...
    if(is_array($array)){            
        ...
        padding-bottom: 12px;
        '>
        <button title='Haga clic aqui para mostrar todos los contratos' style = 'padding: 3px;' class='Mbtn btn-tercero' id='btntodos' onclick='Contratos(3);'><img src='icon/reportes.png' style='padding: 3px; width:30px; height:30px;'></button> ";
        $tb = $tb. "<button title='Haga clic aqui para regresar 10 contratos atras' style = 'padding: 3px;' class='Mbtn btn-secundario' id='btnleft' onclick='Contratos(2);'><img src='icon/btn_izquierda.png' style='padding: 3px; width:30px; height:30px;'></button> ";
        $tb = $tb. "<button title='Haga clic aqui para avanzar viendo los contratos' style = 'padding: 3px;' class='Mbtn btn-secundario' id='btnright' onclick='Contratos(1);'><img src='icon/btn_derecha.png' style='padding: 3px; width:30px;'height:30px;></button> ";
...
$tb = $tb. "<label>* Informacion obtenida desde la delegacion.</label>";
        ...
        $MSSQLestadistica = "
        SELECT
        ISNULL(( SELECT COUNT ( * ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."' OR DomicilioColonia = '".$Col."'  ) ),0) AS TotalDeContratos,
        ISNULL(( SELECT COUNT ( * ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) AND Saldo > 0 ),0) AS Deudores,
        ISNULL(( SELECT COUNT ( * ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) AND Saldo <= 0 ),0) AS SinDeuda,
        ISNULL(( SELECT COUNT ( * ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) AND Errores > 0 ) ,0) AS Errores,
        ISNULL(( SELECT SUM ( Saldo ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) AND Saldo > 0 ),0) AS Saldo_deSaldomayorquecero,
        ISNULL(( SELECT SUM ( Saldo ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) ),0) AS Saldo_todo,
        ISNULL(( SELECT SUM ( Saldo ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."' ) AND errores <= 0 ),0) AS Saldo_sano,
        ISNULL(( SELECT SUM ( Saldo_Moratorio ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) ),0) AS Moratorio_todo,
        ISNULL(( SELECT SUM ( Saldo_Moratorio ) FROM busqueda_vivienda_informacioncontratos WHERE IdDelegacion = 6 AND ( Colonia = '".$Col."'  OR DomicilioColonia = '".$Col."'  ) AND errores <= 0 ),0) AS Moratorio_sano
