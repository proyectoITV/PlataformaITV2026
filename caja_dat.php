...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    // if(isset($IdDelegacion) and isset($IdPrograma) and isset($_GET['OriginData']) and isset($_GET['NumContrato']) and isset($Folio))
    {
      ...
      $ContratoCancelado = ContratoCancelado($NumContrato, $IdDelegacion,$OriginData);
      ...
      if($ContratoCancelado==1)
        ...
        {  
          //echo 'entro else';
          //echo $IdDelegacion.$IdPrograma.$Folio;
        ...
        success: function(data){     
           ...
           // console.log('datos'+datosRecibo);
            ...
            if (datosRecibo === undefined) {
              ...
              window.location.href = window.location.href + "?DatosRecibo="+datosRecibo+"&IdDelegacion="+IdDelegacion+"&IdPrograma="+IdPrograma+"&Folio="+Folio; 
            }               
