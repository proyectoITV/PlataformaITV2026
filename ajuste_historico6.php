...
$id_aplicacion ="ap128"; $nivel = aplicacion_nivel($id_aplicacion, $nitavu);
...
if (sanpedro($id_aplicacion, $nitavu)==TRUE){
    ...
    if (isset($_GET['NumContrato'])){
        ...
        echo '<h1 class="card-header h5">Registro de Reintegros del Instituto</h1>';
        $sqltc = "SELECT idtipomov,descripcionmovimiento FROM descripcionmovimiento where idtipomov in (69,70,91,137,140) ORDER BY descripcionmovimiento";
                
           
        
       
            echo '<div class="card-body">';  
                echo "<form action='ajuste_historico6.php' method='GET'>";
                ...
                echo "<center>";
                    ...
                    echo "<br><label>Nombre del Trabajador</label>";
                    ...
                    echo "<label>Tipo de Reintegro</label>
   ...
   if(isset($_GET['aprobar'])){
    ...
    "'.$SaldoCapitalCorriente.'","","'.$cargo.'",1,now(),"","","'.$nitavu.'","","'.$observaciones.'","'.$saldoexento.'","","","","'.$nombre.'",""
    ...
    if ($Vivienda->query($nuevo) == TRUE){   
        ...
        while($fx = $r2 -> fetch_array()) {
            if ($fx['Estatuscuenta']== 1){
                ...
                echo $sql3;
                if ($Vivienda->query($nuevo) == TRUE){   
                    mensaje ("Operación realizada con éxito",'ajuste_historico6.php');
                }else{
                    mensaje ("ERROR: Ocurrio un error al realizar la operación.",'ajuste_historico6.php');
                }
