    ...
    echo "</td><td>";
        ...
        while($f = $r -> fetch_array()) {
            echo "<article class='IMGnormal'>";
                echo "<a class='Mbtn btn-cancel' href='atencionp.php?x=".$f['id']."' id='cerrar'><img src='icon/cancel.png' style='width:18px;'></a>";
        ...
        echo "<input type='submit' name='btnSubir' class='Mbtn btn-azulTam' value='Guardar'>";
        echo "</form>";
        echo "<div id='R'></div>";
        echo "</article>";
        echo "</div>";
