...
$nivel = aplicacion_nivel($id_aplicacion, $nitavu);	
	...
	if (isset($_GET['id'])){//el usuario selecciono un empleado
		...
		echo "<br><input type='submit' class='Mbtn btn-default' name='submit_asignar' value='Asignar'></td><tr></table>";
		echo "</div>";

		echo "<div>
		<div id='AppDetalle'>Lista de dptos</div>";
		if (isset($_GET['id'])){
			...
			while($dp = $rc -> fetch_array()) 
			{
				...
				echo "<td><a href='autoriza_pases.php?id=".$_GET['id']."&x=".$dp['dpto']."' class='Mbtn btn-cancel'>X</a>";
				echo "</tr>";
			}	
			echo "</table>";
		}
