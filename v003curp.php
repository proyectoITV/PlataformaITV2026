  ...
  if (isset($_GET['curp'])){
    ...
    if(is_array($array)){        
        foreach ($array as $value) {
            ...
            ";
            echo "<input type='hidden' id='nombre' name='nombre' value='".$value['nombres']."'>";
            echo "<input type='hidden' id='ap' name='ap' value='".$value['apellido1']."'>";
            echo "<input type='hidden' id='am' name='am' value='".$value['apellido2']."'>";
            echo "<input type='hidden' id='sexo' name='sexo' value='".$value['sexo']."'>";
            echo "<input type='hidden' id='fechan' name='fechan' value='".$FechaNacimiento."'>";
            echo "<input type='hidden' id='nacionalidad' name='nacionalidad' value='".$value['nacionalidad']."'>";
            echo "<input type='hidden' id='entidad' name='entidad' value='".$value['numEntidadReg']."'>";
            echo "<input type='hidden' id='status' name='status' value='".$value['statusCurp']."'>";
            }
            $c= $c +1;
        }
    } else {
    ...
    echo "<div id='DatosDelCurp' style='width:100%'>";
