...
<body>
	...
	<div id='FileList' style='margin-top:60px'>
		...
		echo "<div id='Ayudas' class='container' style='
				...
				'>";
		TablaDinamica_MySQL("", $sql, "AyudaLista", "AyudaTabla", "Tabla", 2, 25, '[[0, "desc"]]'); //0 = Basica, 1 = ScrollVertical, 2 = Scroll Horizontal
		echo "</div>";
		...
		<form method='POST' enctype='multipart/form-data' id='FormSubir'>
			<div class="modern-form-group">
				...
				<div class="file-upload-wrapper">
					...
					<input type='file' name='archivo[]' id='archivo' accept='.pdf' multiple required
						onchange="document.getElementById('file-upload-text').innerText = this.files.length + ' archivo(s) seleccionado(s)';">
				</div>
			</div>

			<div class="modern-form-group">
				<label>Descripción (aplica a todos los archivos):</label>
				<textarea name='FileDescripcion' class="modern-textarea" placeholder="Escriba una breve descripción..."
					required></textarea>
			</div>
