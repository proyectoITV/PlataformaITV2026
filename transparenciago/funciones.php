...
function GenerarGrafica($nitavu, $id_rep, $token, $var1, $var2, $var3){
...
function TablaDinamica_MySQL($tbCont, $sql, $IdDiv, $IdTabla, $Clase, $Tipo){
	...
	if ($tbCont == '') {
        ...
        <table id="'.$IdTabla.'" class="display tabla" style="width:100%" class="" style="font-size:8pt;">';
    $tabla_titulos = ""; $cuantas_columnas = 0;
        ...
        {//LISTAR COLUMNAS
            ...
            $tbCont = $tbCont."<tr>";        
            for ($i = 1; $i <= $cuantas_columnas; $i++) {      
                $tbCont = $tbCont."<td style='font-size:10pt; color:black;'>".$f[$i-1]."</td>";       
                }
