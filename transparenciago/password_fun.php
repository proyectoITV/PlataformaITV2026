...
function PasswordHash_create($IdEmpleado, $Password) {
    ...
    if ($conexion->query($sql) == TRUE){                   	
        historia($IdEmpleado,"[NIP] cambio su nip con hash ");
		return TRUE;
	} else {
		return FALSE;
	}
...
function EnviarCorreo($Asunto, $Contenido, $CorreoDestino, $DestinoName, $ResponderCorreo = "", $Responder = ""){    
    require("config.php"); require_once('mailer/PHPMailerAutoload.php');
