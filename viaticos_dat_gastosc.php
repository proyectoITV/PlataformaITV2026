...
if ($IdEstatus == 1){
    ...
    echo "<th style = 'BACKGROUND-COLOR: #ddc9a3; Color: black;'>Cantidad</th>";
    echo "<th style = 'BACKGROUND-COLOR: #ddc9a3; Color: black;'>Comprobada</th>";
    echo "<th style = 'BACKGROUND-COLOR: #ddc9a3; Color: black;'>Archivos</th>";
    echo "<th style = 'BACKGROUND-COLOR: #ddc9a3; Color: black;'>Guardar</th>";
    while($f = $r -> fetch_array()) {
        if ($f['Cantidad']==$f['CantidadComprobada']){
            echo "<tr style='background-color: #bc955c;'>";    
        } else {
        ...
        echo "<div style='
        width:100px; display:inline-block; margin:3px; border-radius:3px;  background-color: #4b48483b; padding:4px;
        '><label>";
        ...
        if ($f['pdf1']<>''){
            ...
            echo ""."<img src='icon/pdf.png' style='width:32px;'>"."";
        }
        ...
        if ($f['xml']<>''){
            ...
            echo ""."<img src='icon/xml2.png' style='width:32px;'>"."";
        }
        ...
        ";
        echo "<button style = 'margin-top: 20px; background-color:#ddc9a3; border-color: #ddc9a3; box-shadow: 0 3px #bc955c;' class='btn btn-primary'
        onclick='fun".$f['IdGastoF']."();'
        ><img src='icon/guardar_blanco.png' style='width:32px'></button>";
        echo"</td>";
	...
	if($fc = $rC -> fetch_array())
	{
        ...
        echo "<tr>";
            ...
            '>";
            echo "
            <label style='color: black;'>Estado de la Comprobación</label><br>
            <b style='color: black; font-size:20pt;'>".$fc['Comprobacion']."</b>";
    ...
    echo "<b>EL VIATICO SE ENCUENTRA EN ESTATUS COMPROBADO</b>";
}
