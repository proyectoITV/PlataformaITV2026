...
if ( isset($_POST['search_field']) ){
    ...
    if ( strlen($buscar)>10 ){
        ...
        while($f = $r -> fetch_array()) {
            ...
            echo "<a href='atencion.php?tt=1&id=".$f['id']."' class='Mbtn btn-default' title='Crear un Turno'>Seleccionar</a>  ";
            // echo "<a href='atencion.php?tt=1&id=".$f['id']."&area=2' class='Mbtn btn-default' title='Crear un Turno'>Ejecutivo</a>  ";
        ...
        echo "<a href='atencion.php?app=atencion' class='Mbtn btn-celesteTam'>Buscar nuevamente </a> ";
        echo "<a href='atencion.php?clinvo=1&name=".$buscar."' class='Mbtn btn-verdeTam' title='Usarse esta opcion si no se encuentra en la busqueda'>Cliente Nuevo </a>";
        echo "<br><br><br>";
    } else {
    ...
    if ( isset($_GET['clinvo']) and isset($_GET['name'])){
        ...
        echo "</select>";
        echo "<div><a href='atencion.php?app=atencion' class='Mbtn btn-celesteTam'>Regresar </a>  </div>";
        echo "<div><input type='submit' value='Turno' name='btnArea2' class='Mbtn btn-verdeTam' style='  height: 39px;font-size:12pt;'></div>";
        echo "</form>";
        echo "</div></div>";
    ...
    if (isset($_GET['tt']) and isset($_GET['id'])){
        ...
        echo "</select>";
        echo "<div><a href='atencion.php?app=atencion' class='Mbtn btn-celesteTam'>Regresar </a>  </div>";
        echo "<div><input type='submit' value='Turno' name='btnArea' class='Mbtn btn-verdeTam' style='  height: 39px;font-size:12pt;'></div>";
        echo "</form>";
        echo "</div></div>";
