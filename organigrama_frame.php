...
<head>
  ...
  #organigrama_flow { 
  	width: 2000px; height: 20px; padding: 0.5em; 
...
-moz-box-shadow: 2px 3px 22px #0d294a;
-webkit-box-shadow: 2px 3px 22px #0d294a;
box-shadow: 2px 3px 22px #0d294a;
}
.myNodeClass img {
	border-radius: 10px;
...
<H4>* Clic sobre la foto para ir a editar los datos del empleado<br> * Doble clic en el reacuadro gris para colapsar dependencias</H4>
...
while($f = $r2 -> fetch_array())
{
	if ($f['nivel']=='CONSEJO'){
		...
		while($n1 = $r3 -> fetch_array())
		{
			...
			$str_java=$str_java."[{v:'".$n1['nombre']."', f:'".$n1['nombre']."<div style=color:#004274; ><br>". ponerfoto_org("fotos/".$n1['titular'].".jpg",$n1['titular'])." <br>".nitavu_nombre($n1['titular'])."</div>'},'".$f['nombre']."', 'VP'],";
			...
			// echo "<ol>";			
			 ...
			 // 	
				...
				$dep2 = $dep2."<br>".nitavu_nombre($n2['titular'])."</div>'";
...
//#333333
					...
					$dep3 = "'".$n3['nombre']."<div style=color:#333333;>";
					$dep3 = $dep3."<br>".ponerfoto_org('fotos/'.$n3['titular'].'.jpg',$n3['titular']);
					$dep3 = $dep3."<br>".nitavu_nombre($n3['titular'])."</div>'";
					...
					$dep4 = "'".$n4['nombre']."<div style=color:#FF3300;>";
					$dep4 = $dep4."<br>".ponerfoto_org('fotos/'.$n4['titular'].'.jpg',$n4['titular']);
					$dep4 = $dep4."<br>".nitavu_nombre($n4['titular'])."</div>'";
					...
					$str_java=$str_java."[".$dep4.", ".$dep3.",''],";
						...
						while($n5 = $r6 -> fetch_array())
						{
							...
							$dep5 = "'".$n5['nombre']."<div style=color:#993366;>";
							$dep5 = $dep5."<br>".ponerfoto_org('fotos/'.$n5['titular'].'.jpg',$n5['titular']);
							$dep5 = $dep5."<br>".nitavu_nombre($n5['titular'])."</div>'";
...
?>
 ...
 <script type="text/javascript">
      ...
      function drawChart() {
        ...
        // data.addRows([
        //   [{v:'Mike', f:'Mike<div style="color:green; font-style:italic">Presidente</div>'},
        //    '', 'The President'],
        //   [{v:'Jim', f:'Jim<div style="color:gray; font-style:italic">Vice President</div>'},
        //    'Mike', 'VP'],
        //   ['Alice', 'Mike', ''],
        //   ['Bob', 'Jim', 'Bob Sponge'],
        //   ['Carol', 'Alice', '']
